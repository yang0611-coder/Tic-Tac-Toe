...
- **Version:** 0.9.4-insider.1 (see HTML comment above — this value is stamped during install/upgrade). Include it as `Squad v0.9.4-insider.1` in your first response of each session (e.g., in the acknowledgment or greeting).
