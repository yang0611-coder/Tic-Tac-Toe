...
|-----------|----------|----------|
| Architecture & design | Neo | Project structure, file organization, API design |
| UI, HTML, CSS, styling | Trinity | Game board layout, neo-brutalist design, animations, responsive |
